            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orden.cantidad.label" default="Cantidad" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: ordenInstance, field: "cantidad")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orden.pedido.label" default="Pedido" /></td>
                            
                            <td valign="top" class="value"><g:link controller="pedido" action="show" id="${ordenInstance?.pedido?.id}">${ordenInstance?.pedido?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="orden.producto.label" default="Producto" /></td>
                            
                            <td valign="top" class="value"><g:link controller="producto" action="show" id="${ordenInstance?.producto?.id}">${ordenInstance?.producto?.encodeAsHTML()}</g:link></td>
